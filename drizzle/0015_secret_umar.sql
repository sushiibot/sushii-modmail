DROP INDEX `bot_emojis_name_unique`;--> statement-breakpoint
ALTER TABLE `bot_emojis` ADD `application_id` text;--> statement-breakpoint
CREATE UNIQUE INDEX `bot_emojis_app_name_idx` ON `bot_emojis` (`application_id`,`name`);--> statement-breakpoint
...
CREATE TABLE `__new_threads` (
	...
	`title` text,
	`created_at` integer DEFAULT '"2026-07-10T21:10:38.603Z"' NOT NULL,
	`closed_at` integer,
	`closed_by` text,
...
ALTER TABLE `config` ADD `application_id` text;