...
CREATE TABLE `__new_threads` (
	...
	`title` text,
	`created_at` integer DEFAULT '"2025-05-07T04:51:39.112Z"' NOT NULL,
	`closed_at` integer,
	`closed_by` text,
...
ALTER TABLE `config` ADD `prefix` text;--> statement-breakpoint
ALTER TABLE `config` ADD `forum_channel_id` text;--> statement-breakpoint
ALTER TABLE `config` ADD `logs_channel_id` text;--> statement-breakpoint
ALTER TABLE `config` ADD `required_role_ids` text DEFAULT '[]' NOT NULL;--> statement-breakpoint
ALTER TABLE `config` ADD `initial_message` text;--> statement-breakpoint
ALTER TABLE `config` ADD `anonymous_snippets` integer DEFAULT true NOT NULL;