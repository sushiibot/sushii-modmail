...
CREATE TABLE `__new_message_versions` (
	...
	`edited_at` integer DEFAULT '"2025-05-20T04:10:17.036Z"' NOT NULL,
...
CREATE TABLE `__new_threads` (
	...
	`title` text,
	`created_at` integer DEFAULT '"2025-05-20T04:10:17.034Z"' NOT NULL,
	`closed_at` integer,
	`closed_by` text,
...
ALTER TABLE `config` ADD `notification_role_id` text;--> statement-breakpoint
ALTER TABLE `config` ADD `notification_silent` integer DEFAULT false NOT NULL;