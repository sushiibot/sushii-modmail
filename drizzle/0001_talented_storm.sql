...
CREATE TABLE `__new_threads` (
	...
	`title` text,
	`created_at` integer DEFAULT '"2025-03-28T05:07:57.508Z"' NOT NULL,
	`closed_at` integer,
	`closed_by` text,
...
ALTER TABLE `messages` ADD `is_anonymous` integer;--> statement-breakpoint
ALTER TABLE `messages` ADD `is_plain_text` integer;--> statement-breakpoint
ALTER TABLE `messages` ADD `is_snippet` integer;